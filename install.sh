...
case "$os" in
  ...
  *) die "unsupported OS: $os (Keysmith supports Linux and macOS)" ;;
esac
...
archive="keysmith-${target}.tar.gz"
...
install -m 755 "${tmp_dir}/keysmith" "${INSTALL_DIR}/keysmith"

echo ""
echo "keysmith installed to ${INSTALL_DIR}/keysmith"
case ":$PATH:" in
  *":$INSTALL_DIR:"*) ;;
  *) echo "Note: ${INSTALL_DIR} is not on your PATH. Add it, e.g.:" ;
     echo "  export PATH=\"${INSTALL_DIR}:\$PATH\"" ;;
esac
echo "Run 'keysmith --help' to get started."
